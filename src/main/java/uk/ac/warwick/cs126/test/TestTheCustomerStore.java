...
public class TestTheCustomerStore extends TestRunner {
    ...
    private void testAddCustomer() {
        try {
            ...
            boolean result2 = customerStore.addCustomer(customer2);
            boolean result3 = customerStore.addCustomer(customer3);

            Customer[] customers = customerStore.getCustomers();
    ...
    private void testGetCustomers() {
        try {
            ...
            if (gotCustomers.length == expectedCustomers.length) {
                ...
                System.out.println("different length arrays");
                result = false;
            }
