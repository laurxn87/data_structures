...
public class TestTheReviewStore extends TestRunner {
    ...
    private void testGetReviewsByRestaurantID() {
        try {
            ...
            for(int i=0;i< gotReviews.length;i++){
                System.out.println(gotReviews[i]);
            }
            boolean result = false;
    ...
    private void testGetAverageCustomerReviewRating() {
        try {
            ...
            // Get reviews sorted by ID from store
            System.out.println(reviewStore.getAverageCustomerReviewRating(3293658679813597L));
            boolean result = false;
    ...
    private void testGetCustomerReviewHistogramCount() {
        try {
            ...
            int[] hist = reviewStore.getCustomerReviewHistogramCount(3293658679813597L);
    ...
    private void testGetTopRestaurantsByReviewCount() {
        try {
            ...
            // Add to store to be processed
            reviewStore.addReview(reviews);
            Long[] ids = reviewStore.getTopRestaurantsByReviewCount();
    ...
    private void testGetTopCustomersByReviewCount() {
        try {
            ...
            // Add to store to be processed
            reviewStore.addReview(reviews);
            Long[] ids = reviewStore.getTopCustomersByReviewCount();
            for(int i =0;i<ids.length;i++){
                System.out.println(ids[i]);
            }
            boolean result = false;
    ...
    private void testGetTopRatedRestaurants() {
        try {
            ...
            // Add to store to be processed
            reviewStore.addReview(reviews);
            Long[] ids = reviewStore.getTopRatedRestaurants();
            for(int i =0;i<ids.length;i++){
                System.out.println(ids[i]);
            }
            boolean result = false;
    ...
    private void testGetTopKeywordsForRestaurant() {
        try {
            ...
            // Add to store to be processed
            reviewStore.addReview(reviews);
            String[] keywords = reviewStore.getTopKeywordsForRestaurant(2516282978916487L);
    ...
    private void testGetReviewsContaining() {
        try {
            ...
            // Add to store to be processed
            reviewStore.addReview(reviews);
            Review[] gotreviews = reviewStore.getReviewsContaining("o");
            for(int i =0;i<gotreviews.length;i++){
                System.out.println(gotreviews[i]);
            }
            boolean result = false;
